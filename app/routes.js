module.exports = function(app, passport) {
    ...
    app.get('/getallbooks', function(req, res,next) {
        var allGetter=require("./getallbooks.js");
        allGetter.getAll(req,res,next);
    });
    app.post('/insertbook',isLoggedIn2, function(req, res,next) {
        var Inserter=require("./insertbook.js");
        Inserter.insertNew(req,res,next);
    });
    app.get('/getmybooks', isLoggedIn2,function(req, res,next) {
        var myGetter=require("./getmybooks.js");
